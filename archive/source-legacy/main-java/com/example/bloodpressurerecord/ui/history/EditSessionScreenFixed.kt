...
fun EditSessionScreen(
    ...
    if (uiState.showHighRiskDialog) {
        AlertDialog(
            ...
            title = { Text("高优先级提醒") },
            text = { Text("检测到超过 180/120 的高值，是否继续保存编辑结果？") },
    ...
    Column(
        ...
        Text("编辑记录", style = MaterialTheme.typography.headlineMedium)
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.padding(14.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                ...
                EditReadingBlock("第1组读数", uiState.reading1, viewModel::updateReading1Systolic, viewModel::updateReading1Diastolic, viewModel::updateReading1Pulse)
                EditReadingBlock("第2组读数", uiState.reading2, viewModel::updateReading2Systolic, viewModel::updateReading2Diastolic, viewModel::updateReading2Pulse)

                if (uiState.showThirdReading) {
                    EditReadingBlock("第3组读数（可选）", uiState.reading3, viewModel::updateReading3Systolic, viewModel::updateReading3Diastolic, viewModel::updateReading3Pulse)
                ...
                Text("症状标签（可多选）", style = MaterialTheme.typography.titleMedium)
                FlowRow(horizontalArrangement = Arrangement.spacedBy(8.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                if (uiState.message.isNotBlank()) {
                    val success = uiState.message.contains("成功")
