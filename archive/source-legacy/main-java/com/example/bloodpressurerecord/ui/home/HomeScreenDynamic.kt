...
fun HomeScreen(viewModel: HomeViewModel) {
    ...
    if (uiState.showHighRiskDialog) {
        AlertDialog(
            ...
            title = { Text("高风险提醒") },
            text = { Text("读数超过 180/120，是否继续保存本次记录？") },
    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.padding(14.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                ...
                ReadingBlock("第1组", uiState.reading1, viewModel::updateReading1Systolic, viewModel::updateReading1Diastolic, viewModel::updateReading1Pulse)
                ReadingBlock("第2组", uiState.reading2, viewModel::updateReading2Systolic, viewModel::updateReading2Diastolic, viewModel::updateReading2Pulse)
