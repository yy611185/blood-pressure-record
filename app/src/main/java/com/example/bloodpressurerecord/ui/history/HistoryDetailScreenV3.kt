...
fun HistoryDetailScreen(
    ...
    Column(
        ...
        Row {
            com.example.bloodpressurerecord.ui.common.AppBackButton(onClick = onBackToHistory)
            Text("测量详情", style = MaterialTheme.typography.headlineMedium, modifier = Modifier.padding(start = 4.dp))
        }
        if (session == null) {
            Text("未找到该记录。")
